        ...
        Plugin.prototype = {
            init: function () {
                ...
                this.$label.css({
                    ...
                    // Changed this to 10 from 8 :: Morgan J Lopes // MoodyCall
                    ...
                    'opacity'                       : '0',
                    'font-size'                     : '11px',
                    // Changed this to 400 from bold :: Morgan J Lopes // MoodyCall
                    'font-weight'                   : '400',
                    'color'                         : '#838780'
                });
...
(function() {
  jQuery(function() {
    ...
    $('#batch_projected_volume_in_gallons').keyup(function() {
      var bottle_12_oz_count, bottle_12_oz_extra, bottle_12_oz_extra_in_oz, bottle_12_oz_whole, bottle_22_oz_count, bottle_22_oz_extra, bottle_22_oz_extra_in_oz, bottle_22_oz_whole, full_growler_count, full_growler_extra, full_growler_extra_in_oz, full_growler_whole, half_growler_count, half_growler_extra, half_growler_extra_in_oz, half_growler_whole, volume_as_fluid_ounces, volume_as_liters, volume_as_pints, volume_value_in_gallons;
      ...
      return $('#calculated_bottle_12_oz_extra_in_oz').html(bottle_12_oz_extra_in_oz.toFixed(0));
    }).keyup();
    return $("a[href^=\"#\"]").bind("click.smoothscroll", function(e) {
      var $target, target;
      e.preventDefault();
      target = this.hash;
      $target = $(target);
...
(function() {
  jQuery(function() {
    return $('#recipe_events_table tr select').change(function() {
      var child;
      if ($(this).val() === "Start Boil") {
        child = $(this).closest("tr").children("td.recipe_event_subject_column");
        return child.children(".recipe_recipe_events_subject").hide();
      } else if ($(this).val() === "Terminate Boil") {
        child = $(this).closest("tr").children("td.recipe_event_subject_column");
        return child.children(".recipe_recipe_events_subject").hide();
      } else {
        child = $(this).closest("tr").children("td.recipe_event_subject_column");
        return child.children(".recipe_recipe_events_subject").show();
      }
    }).change();
  });
